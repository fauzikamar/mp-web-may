    ...
    <div className="min-h-screen flex flex-col bg-white">
        ...
        <div className="section-content">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 border border-gray-200 rounded">
              <h3 className="text-xl font-bold text-[#1e5a96] mb-4">Power Transformer Repair & Refurbishment</h3>
            ...
            <div className="bg-white p-8 border border-gray-200 rounded">
              <h3 className="text-xl font-bold text-[#1e5a96] mb-4">Oil Filtration Work</h3>
            ...
            <div className="bg-white p-8 border border-gray-200 rounded">
              <h3 className="text-xl font-bold text-[#1e5a96] mb-4">Installation, Testing & Commissioning</h3>
            ...
            <div className="bg-white p-8 border border-gray-200 rounded">
              <h3 className="text-xl font-bold text-[#1e5a96] mb-4">Electrical Engineering Services</h3>
        ...
        <div className="section-content">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-slate-800/50 p-8 border border-[#00d4ff]/30">
              <h3 className="text-2xl font-bold text-[#00d4ff] mb-4">Oil Immersed Power Transformers</h3>
            ...
            <div className="bg-slate-800/50 p-8 border border-[#00d4ff]/30">
              <h3 className="text-2xl font-bold text-[#00d4ff] mb-4">Distribution Transformers</h3>
            ...
            <div className="bg-slate-800/50 p-8 border border-[#00d4ff]/30">
              <h3 className="text-2xl font-bold text-[#00d4ff] mb-4">High Voltage Switchgear</h3>
          ...
          <div className="grid grid-cols-1 mt-8">
            <div className="bg-slate-800/50 p-8 border border-[#00d4ff]/30">
              <h3 className="text-2xl font-bold text-[#00d4ff] mb-4">Transformer Accessories</h3>
      ...
      <section className="section-full section-light">
        <div className="section-content">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 border border-gray-200 rounded">
              <h3 className="text-xl font-bold text-[#1e5a96] mb-4">Civil Works</h3>
            ...
            <div className="bg-white p-8 border border-gray-200 rounded">
              <h3 className="text-xl font-bold text-[#1e5a96] mb-4">Mechanical & Electrical (M&E)</h3>
      ...
      <section className="section-full section-dark">
        <div className="section-content">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-slate-800/50 p-8 border border-[#00d4ff]/30 text-center">
              <p className="text-4xl font-bold text-[#00d4ff] mb-3">15+</p>
            ...
            <div className="bg-slate-800/50 p-8 border border-[#00d4ff]/30 text-center">
              <p className="text-4xl font-bold text-[#00d4ff] mb-3">200+</p>
            ...
            <div className="bg-slate-800/50 p-8 border border-[#00d4ff]/30 text-center">
              <p className="text-4xl font-bold text-[#00d4ff] mb-3">24/7</p>
